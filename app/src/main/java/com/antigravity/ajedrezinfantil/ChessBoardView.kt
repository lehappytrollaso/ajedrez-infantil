...
enum class BoardTheme(
    ...
    FANTASY("Reino Mágico", Color.parseColor("#FFF6E6"), Color.parseColor("#9C88B9"), Color.parseColor("#7E57C2"), Color.parseColor("#26A69A")),
    FOREST("Bosque Esmeralda", Color.parseColor("#F1F8E9"), Color.parseColor("#81C784"), Color.parseColor("#388E3C"), Color.parseColor("#FFA000")),
    ICE("Reino de Hielo", Color.parseColor("#E3F2FD"), Color.parseColor("#90CAF9"), Color.parseColor("#1976D2"), Color.parseColor("#FF6584")),
    CANDY("Mundo Caramelo", Color.parseColor("#FFF8E1"), Color.parseColor("#F48FB1"), Color.parseColor("#C2185B"), Color.parseColor("#26A69A"))
}
